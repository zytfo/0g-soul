      ...
      <div className="terminal rounded-sm">
        <div className="flex items-center justify-between border-b border-[var(--phosphor-deep)] px-3 py-2 text-xs">
          <div className="flex items-center gap-2 min-w-0">
            <Image src="/logo.png" alt="" width={16} height={16} className="opacity-90 shrink-0" />
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="leading-none">
        <div className="glow font-[family-name:var(--font-display)] text-[clamp(40px,9vw,72px)]" aria-label="SOUL">
          SOUL
        </div>
